...
(function() {
	tinymce.create( 'tinymce.plugins.wmShortcodes', {
		...
		*/
		init : function( ed, url ) {
			...
			ed.addButton( 'sp_mce_button_shortcodes', {
			...
			// Register example button
			ed.addButton( 'sp_mce_button_line_above', {
			...
			// Register example button
			ed.addButton( 'sp_mce_button_line_below', {
	...
	// Register plugin
	tinymce.PluginManager.add( 'sp_mce_button', tinymce.plugins.wmShortcodes );
})();
